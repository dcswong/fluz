        ...
        <FollowUs>FOLLOW US</FollowUs>
          {lodash.map(social, (socials, index) => {
              return (
                <div>
                  <a href={socials.link}>
                    <SocialIcon src={socials.img} width="16px"/>
                  </a>
                </div>
              )
          })}
...
SocialMedia.defaultProps = {
  social:[
    ...
    {
      link:'',
      img:'data:image/png;base64,'
    },
    {
      link:'',
